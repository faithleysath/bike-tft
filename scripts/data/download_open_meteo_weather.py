#!/usr/bin/env python3
"""Download hourly Open-Meteo weather data into the project's raw data directory."""
...
DEFAULT_OUTPUT_DIR: Final[Path] = Path("data/raw/stage_02_feature_enrichment/weather")
