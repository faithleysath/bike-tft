"""Train target/loss ablations for the NYC relational AGCRN model."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train NYC relational AGCRN objective ablations.")
    ...
    parser.add_argument("--output-dir", default="forecasting_models/agcrn_nyc_objective_v1/runs/default")
