...
DEFAULT_CHECKPOINT = Path("forecasting_models/agcrn_nyc_gwnet_v1/runs/gwnet_top883_log1p_topk20_b64/best_model.pt")
DEFAULT_OUTPUT = Path("forecasting_models/agcrn_nyc_gwnet_v1/runs/gwnet_top883_log1p_topk20_b64/test_forecasts_for_rebalancing.parquet")
...
def collect_test_predictions(model: GraphWaveNet, data, device: torch.device) -> np.ndarray:
    ...
    for x, _y, _raw_y, baseline in data.test_loader:
