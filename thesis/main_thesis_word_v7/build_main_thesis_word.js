...
const OUT_DOCX = path.join(OUT_DIR, "main_thesis_word_v7_final.docx");
const OUT_PDF = path.join(OUT_DIR, "main_thesis_word_v7_final.pdf");
const DRAFT_DOCX = path.join(WORK_DIR, "main_thesis_word_v7_pass1.docx");
const DRAFT_PDF = path.join(WORK_DIR, "main_thesis_word_v7_pass1.pdf");
const REPORT = path.join(OUT_DIR, "visual_check_report.md");
const MANIFEST = path.join(OUT_DIR, "main_thesis_word_v7_manifest.json");
